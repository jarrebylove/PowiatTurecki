...
public final class MessagesContract {
    ...
    public static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + MessageEntry.TABLE_NAME + " (" +
                    ...
                    MessageEntry.COLUMN_NAME_SOURCE_ID + " INTEGER," +
                    MessageEntry.COLUMN_NAME_CATEGORY_ID + " INTEGER," +
                    MessageEntry.COLUMN_NAME_BEGIN + " INTEGER," +
                    MessageEntry.COLUMN_NAME_END + " INTEGER," +
                    MessageEntry.COLUMN_NAME_TITLE + " TEXT," +
                    MessageEntry.COLUMN_NAME_PAGE_ID + " INTEGER)";
